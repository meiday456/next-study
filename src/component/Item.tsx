        ...
        <>
            <div className={styles.wrap}>
                ...
                <div className={styles.info_item}>
                    ...
                    <Button color="red" onClick={push}>router push</Button>
                    <Button color="red" onClick={replace}>router replace</Button>
                    <Button color="red" onClick={back}>router back</Button>
                    <Button color="red" onClick={reload}>router reload</Button>
                    <Button color="red" onClick={prefetch}>router prefetch</Button>
                </div>
            </div>
